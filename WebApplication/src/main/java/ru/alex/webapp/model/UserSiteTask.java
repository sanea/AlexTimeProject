...
@NamedQueries({
        ...
        @NamedQuery(name = UserSiteTask.ALL_CURRENT_TIME_BY_SITE, query = "SELECT u FROM UserSiteTask u WHERE u.currentTime is not null and u.siteTask.siteBySiteId.id = :siteId"),
...
public class UserSiteTask implements Serializable {
    ...
    public static final String ALL_CURRENT_TIME_BY_SITE = "UserSiteTask.ALL_CURRENT_TIME_BY_SITE";
