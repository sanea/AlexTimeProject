...
<head>
    ...
    <link href="resources/bootstrap_toRemove/css/bootstrap.css" rel="stylesheet">
    <style type="text/css">
        body {
            padding-top: 40px;
            padding-bottom: 40px;
    ...
    <link href="resources/bootstrap_toRemove/css/bootstrap-responsive.css" rel="stylesheet">
    <script src="resources/js/jquery-1.9.1.js"></script>
    <script src="resources/bootstrap_toRemove/js/bootstrap.js"></script>
</head>
<body>
